...
| --- | --- | --- | --- | --- | --- |
| `douyin` | Douyin / 抖音 | `live.douyin.com`, `v.douyin.com`, `www.douyin.com` | 内置网页解析 | `douyin` | 仅直接 FLV/HTTP；HLS-only 报错且不创建文件 |
...
| `douyu` | Douyu / 斗鱼 | `douyu.com`, `www.douyu.com`, `m.douyu.com` | 斗鱼公开 H5 API | `douyu` | 仅直接 FLV/HTTP；HLS-only 报错且不创建文件 |
